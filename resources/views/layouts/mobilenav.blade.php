 <!-- Off-canvas menu for mobile, show/hide based on off-canvas menu state. -->
          <div :class="{'hidden': !open}" class="fixed inset-0 flex z-40 md:hidden transition-opacity ease-linear duration-300" role="dialog" aria-modal="true">
            <div :class="{'hidden': !open}" x-on:click="open = !open" class="fixed inset-0 bg-gray-600 bg-opacity-75 transition ease-in-out
            duration-300"
            ...
            <!--
              ...
              Leaving: "transition ease-in-out duration-300 transform"
                ...
                To: "-translate-x-full"
            -->
            <div :class="{'hidden': !open}" class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-gray-800 transition ease-in-out duration-300">
              <!--
              ...
              <div class="absolute top-0 right-0 -mr-12 pt-2">
                <button x-on:click="open = false" class="ml-1 flex items-center justify-center h-10 w-10 rounded-full focus:outline-none
                focus:ring-2
            ...
            <div class="flex-shrink-0 w-14" :class="{'hidden': !open}" aria-hidden="true">
