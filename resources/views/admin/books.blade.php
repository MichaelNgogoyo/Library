                                                    ...
                                                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                                        ...
                                                        <div class="sm:col-span-4">
                                                            ...
                                                            <div class="mt-1">
                                                                ...
                                                                @endphp
                                                                @if($libs->count() > 0)
                                                                    <select id="country" name="library_id"
                                                                            autocomplete="library_id"
                                                                            class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                                                        @foreach($libs as $lib)
                                                                            <option
                                                                ...
                                                                @else
                                                                    <input id="name" name="library_name" type="text"
                                                                           autocomplete="name"
                                                                           class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                                                @endif
                                                            </div>
                                                            ...
                                                            <div class="mt-1">
                                                                <div class="mt-1 flex rounded-md shadow-sm">
                                                                    <div
                                                                        ...
                                                                        @endphp
                                                                        @if($authors->count() > 0)
                                                                            <select x-show="!newAuthor" id="country"
                                                                                    name="author_id"
                                                                            ...
                                                                            <input x-show="newAuthor" type="text"
                                                                    ...
                                                                    <button
                                                                        x-bind:disabled="{{$authors->count() === 0}}"
                                                                        @click.prevent="newAuthor = !newAuthor" class="-ml-px
                                                                ...
                                                                <div class="mt-1 flex rounded-md shadow-sm">
                                                                    <div
                                                                        ...
                                                                        @if($publishers->count() > 0)
                                                                            <select x-show="!newPublisher" id="country"
                                                                                    name="publisher_id"
                                                                            ...
                                                                            <input x-show="newPublisher" type="text"
                                                                    ...
                                                                    <button
                                                                        x-bind:disabled="{{$publishers->count() === 0}}"
                                                                        @click.prevent="newPublisher = !newPublisher"
                                                                        class="-ml-px relative inline-flex  items-center space-x-2 px-4 py-2 border  text-sm font-medium rounded-r-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 "
