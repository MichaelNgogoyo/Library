...
{{--           @include('layouts.includes.empty')--}}
        <div class="w-[20vw] m-0 m-auto">
            ...
            <div class="grid justify-center content-around text-center">
                <h2 class="text-2xl font-bold text-gray-500">No Records yet</h2>
                <p class="text-base text-gray-400">All your registered libraries should appear here..</p>

                <button type="button" class="inline-flex w-[max-content] m-0 m-auto items-center px-2.5 py-1.5 border border-transparent text-xs
                font-medium
                rounded text-gray-700 bg-indigo-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2
