                    ...
                    @if($libs->count() <= 0)
                        <div class="w-[20vw] m-0 m-auto">
                            ...
                            <div class="grid justify-center content-around text-center">
                                ...
                                <p class="text-base text-gray-400">All your registered libraries should appear
                                    here..</p>
                                    ...
                                    <li>
                                        <div class="block hover:bg-gray-50">
                                            <div class="flex items-center px-4 py-4 sm:px-6">
                                                    ...
                                                    <div class="min-w-0 flex-1 px-4 md:grid md:grid-cols-2 md:gap-4">
                                                        <div>
                                                            ...
                                                            <p class="mt-2 flex items-center text-sm text-gray-500">
                                                                ...
                                                                <span
                                                                    class="truncate">{{$lib->created_at->diffForHumans()}}</span>
                                                            </p>
                                                        </div>
                                                ...
                                                <div class="flex">
                                                    <a href="#" class="mr-5" title="Edit library"
                                                       @click.prevent="showEdit = true; editingLibrary = {{$lib}}">

                                                        <i class="far fa-edit text-gray-600"></i>
                                                    </a>

                                                    <a href="#" title="Delete library"
                                                       @click.prevent="showDelete = true; deleteLib = {{$lib}}">
                                                ...
                                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                    ...
                                                    <div class="mt-2">
                                                        <p class="text-sm text-gray-500">
                                                            Are you sure you want to delete library: <strong
